# 📊 Global E-Commerce Sales Anlaysis (Excel)
...
### **Business Insights**
- 🏆 **South Region** recorded the **highest profit**, followed by the **East Region**.  
- 💼 **Technology** and **Furniture** categories drive most of the sales and profits.  
- 🧑‍💼 **Home Office** segment accounts for the **largest share (42%)**, showing strong B2C engagement.  
- 💳 **Cash (27%)** and **PayPal (24%)** are the most preferred payment modes.  
- 💡 Products like **Laptops, Chairs, and Pens** dominate the **Top 10 Sales list**.  
- 📉 Moderate discounts (5–10%) yield **higher profits**, while higher discounts reduce profit margins.  
